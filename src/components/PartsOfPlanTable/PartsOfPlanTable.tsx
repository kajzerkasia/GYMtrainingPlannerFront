...
export const PartsOfPlanTable = () => {
    ...
    useEffect(() => {
        ...
        fetch(`${apiUrl}api/api/add-part/plans`, {
            method: 'GET',
    ...
    const addPartOfPlan = async (values: PartOfPlanEntity) => {
        ...
        const res = await fetch(`${apiUrl}api/api/add-part/plans`, {
            method: 'POST',
            headers: {
    ...
    const editPartOfPlan = async (values: PartOfPlanEntity) => {
        ...
        const res = await fetch(`${apiUrl}api/api/add-part/plans/${values.id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const handleConfirmDelete = async () => {
        const res = await fetch(
            `${apiUrl}api/api/add-part/plans/${partToDeleteId}`,
            {method: "DELETE"}
        )
